  ...
  return (
    <div className="max-w-6xl mx-auto animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 gap-4">
        <div>
          <h2 className="text-2xl font-display font-semibold tracking-tight text-slate-900">Dispatch Command Center</h2>
          <p className="text-sm text-slate-500 mt-1">Optimize Fleet & Crew Assignments</p>
        </div>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6">
             <Card className="bg-slate-50/50 border-none shadow-none">
                 <CardContent>
                     <h3 className="text-lg font-semibold text-slate-900 mb-4">Recently Assigned</h3>
      ...
      >
        {manualAssignRequest && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="truck-select" className="block text-sm font-medium text-slate-700 mb-1">Select Truck</label>
                <select 
                  id="truck-select"
                  className="w-full pl-3 pr-8 py-2 bg-white rounded-lg border border-slate-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 text-sm"
              ...
              <div>
                <label htmlFor="driver-select" className="block text-sm font-medium text-slate-700 mb-1">Select Driver</label>
                <select 
                  id="driver-select"
                  className="w-full pl-3 pr-8 py-2 bg-white rounded-lg border border-slate-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 text-sm"
